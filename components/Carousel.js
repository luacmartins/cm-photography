      ...
      <>
         <div {...swipeHandlers} className="flex items-center relative h-full w-full group transition">
            ...
            <div className="flex h-full w-full overflow-x-hidden">
               {children.map((item, idx) => (
                  <div
                     ...
                     className="min-w-full h-64 overflow-hidden sm:h-128 lg:h-auto transition duration-300"
                  >{item}</div>
               ))}
            </div>
            ...
            <div className="hidden sm:group-hover:block">
               <button className="absolute left-0 ml-2 bg-white rounded-full opacity-50 hover:opacity-75 p-2 focus:outline-none focus:shadow-outline" onClick={slideLeft} >
               ...
               <button className="absolute right-0 mr-2 bg-white rounded-full opacity-50 hover:opacity-75 p-2 focus:outline-none focus:shadow-outline" onClick={slideRight} >
