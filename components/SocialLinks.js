export default function SocialLinks() {
   return (
      <div className="flex">
         <a className="sm:block hover:text-gray-400" href="https://www.instagram.com/ourglobaltrek/" target="_blank">
            <svg className="h-6 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 169.063 169.063">
         ...
         <a className="sm:block ml-4 sm:ml-6 hover:text-gray-400" href="https://www.facebook.com/luacmartins" target="_blank">
