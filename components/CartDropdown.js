      ...
      <div className="flex items-center w-8 sm:relative justify-end">
         ...
         <button className="flex" onClick={toggleCart}>
            {!isCartOpen && <div className="flex">
               ...
               <div className="sm:hidden font-hairline text-xs ml-1 sm:z-10">{cartItems.length}</div>
            </div>}
            {isCartOpen && <div>
            ...
            <span className="hidden sm:flex font-hairline text-xs ml-1 sm:z-10 leading-3">{cartItems.length}</span>
         </button>
